...
BUNDLE_ID="dev.codexisland4custom.app"
VERSION="$(cat VERSION)"
...
cp ./Resources/openclaw_logo.pdf "$RES_DIR/openclaw_logo.pdf"
...
<dict>
  ...
  <key>CFBundleDisplayName</key><string>codexisland4custom</string>
