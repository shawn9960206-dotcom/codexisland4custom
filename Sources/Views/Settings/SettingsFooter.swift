...
struct SettingsFooter: View {
    ...
    private static let githubURL = URL(string: "https://github.com/shawn9960206-dotcom/codexisland4custom")!
    private static let licenseURL = URL(string: "https://github.com/shawn9960206-dotcom/codexisland4custom/blob/main/LICENSE")!
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 14) {
            ...
            .help(L10n.tr("Quit codexisland4custom"))
