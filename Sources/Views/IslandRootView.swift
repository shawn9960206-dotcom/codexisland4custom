...
struct IslandRootView: View {
    ...
    @State private var openClawLogo: NSImage?
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            .background {
                ...
                .overlay(alignment: .topLeading) {
                    LogoOverlay(
                        image: logo(for: agentConfig.leftAgent),
                ...
                .overlay(alignment: .topTrailing) {
                    LogoOverlay(
                        image: logo(for: agentConfig.rightAgent),
        ...
        .accessibilityLabel(L10n.tr("codexisland4custom panel"))
        .accessibilityHint(accessibilityHintForState)
        .onAppear {
            if openClawLogo == nil {
                openClawLogo = Bundle.main.url(forResource: "openclaw_logo", withExtension: "pdf")
    ...
    private func logo(for agent: AgentKind) -> NSImage? {
        switch agent {
...
private struct LogoOverlay: View {
    ...
    var body: some View {
        ...
        if let image {
            ...
            Text(AgentConfigurationStore.shared.shortName(for: provider))
