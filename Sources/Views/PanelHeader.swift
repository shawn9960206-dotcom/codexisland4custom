...
/// Provider titles row — OpenClaw on the left, Codex on the right, with a
...
struct PanelHeader: View {
    ...
    var body: some View {
        HStack(spacing: 0) {
            ...
            providerTitle(name: agentConfig.displayName(for: .claude), tag: usageStore.claude.plan?.uppercased(),
            ...
            providerTitle(name: agentConfig.displayName(for: .codex), tag: usageStore.codex.plan?.uppercased(),
